...
![节点图](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/compositemode1.png)
...
![透明式组合模式结构](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/compositemode2.gif)

#### 安全方式

在该方式中，将管理子构件的方法移到树枝构件中，抽象构件和树叶构件没有对子对象的管理方法，这样就避免了上一种方式的安全性问题，但由于叶子和分支有不同的接口，客户端在调用时要知道树叶对象和树枝对象的存在，所以失去了透明性。其结构图如图 2 所示。

![安全式的组合模式](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/compositemode3.gif)
...
![集合c0的树状图](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/compositemode4.gif)
...
![韶关“天街e角”店购物的结构图](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/composite5.gif)
...
![复杂的组合模式的结构图](https://jwangtec.oss-cn-chengdu.aliyuncs.com/jwangcloud/mode/compositemode6.gif)

# 进阶阅读

如果您想深入了解组合模式，可搜索阅读以下文章。
